...
-- PromotionalPrice là % giảm giá. sale_price = price * (1 - promotional_price_percentage / 100.0)
...
INSERT INTO products (name, price, description, detail, quantity, image, category_id, sale_price, giong, mausac, cannang, size, warranty, status, view_count, created_at, updated_at) VALUES
                                                                                                                                                                                          ...
                                                                                                                                                                                          ('Chó Corgi Fluffy', 10000000.00, 'Chó Corgi Fluffy có ngoại hình nhỏ bé và ngộ nghĩnh, đáng yêu', 'Chúng cũng rất năng động và thông minh nên được nhiều người ưa thích.', 20, 'img/products/dog/sp4.png', 1, NULL, 'Corgi', 'Tricolor', '1.5kg', 'Nhỏ', 6, 'ACTIVE', 220, NOW(), NOW()),
                                                                                                                                                                                          ('Chó Corgi Cardigan Welsh', 12000000.00, 'Cardigan Corgi là giống chó đẹp được ưa chuộng hiện nay', 'Loại chó Cardigan Corgi có đuôi dài', 5,'img/products/dog/sp5.png', 1, NULL, 'Corgi', 'Vện', '2kg', 'Nhỏ', 10, 'ACTIVE', 180, NOW(), NOW());
