...
-- Mật khẩu '123' được mã hóa bằng BCrypt. Thay thế bằng chuỗi mã hóa thực tế của bạn.
-- Ví dụ: '$2a$10$YourEncodedPasswordFor123GoesHere'
INSERT INTO user_account (user_name, password, status) VALUES
                                                           ('testuser', '$2a$10$abcdefghijklmnopqrstuv', 1), -- Thay bằng mật khẩu mã hóa của '123'
                                                           ('adminuser', '$2a$10$uvwxyzabcdefghijklmnop', 1)  -- Thay bằng mật khẩu mã hóa của '123'
ON DUPLICATE KEY UPDATE password = VALUES(password), status = VALUES(status); -- Giả sử user_name là UNIQUE KEY
